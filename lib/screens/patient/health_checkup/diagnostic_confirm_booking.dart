...
class DiagnosticConfirmBooking extends StatefulWidget {
  @override
  _DiagnosticConfirmBookingState createState() =>
      _DiagnosticConfirmBookingState();
}

class _DiagnosticConfirmBookingState extends State<DiagnosticConfirmBooking> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: RichText(
              ...
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(text: TextStrings().bookingConfirmed),
                ],
              ),
            ),
          ),
          ...
          SpaceBox(300),
          CustomButton(
            buttonText: TextStrings().buttonDone,
            onTap: () {
