...
import 'package:atsign_ecare/screens/patient/health_checkup/widgets/book_diagnostic_card.dart';
...
class BookDiagnosticCenter extends StatefulWidget {
  @override
  _BookDiagnosticCenterState createState() => _BookDiagnosticCenterState();
}

class _BookDiagnosticCenterState extends State<BookDiagnosticCenter> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        showTitle: true,
        title: 'Medall Clumax Diagnostics',
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            CustomButton(
              width: 600.toWidth,
              buttonText: TextStrings().buttonBook,
              onTap: () {
                Navigator.pushNamed(context, Routes.DIAGNOSTICCONFIRMBOOKING);
              },
            ),
            SpaceBox(100.toHeight),
          ],
        ),
      ),
    );
