...
class DoctorChatInput extends StatefulWidget {
  @override
  _DoctorChatInputState createState() => _DoctorChatInputState();
}

class _DoctorChatInputState extends State<DoctorChatInput> {
  @override
